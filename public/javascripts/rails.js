...
jQuery(function ($) {
    ...
    /**
     * <%= link_to "Delete", user_path(@user), :method => :delete, :confirm => "Você tem certeza?" %>
     *
     * <a href="/users/5" data-confirm="Você tem certeza?" data-method="delete" rel="nofollow">Delete</a>
     */
